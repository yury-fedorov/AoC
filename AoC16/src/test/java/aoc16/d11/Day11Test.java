...
public class Day11Test {
    ...
    static boolean isChip(int obj) {
        return obj > 0;
    }

    static boolean isGenerator(int obj) {
        return obj < 0;
    }
    ...
    static int nextFloor(int floor, LiftDirection d) {
        return floor + (d == LiftDirection.UP ? 1 : -1);
    }
    ...
    record DirectionOptions(LiftDirection direction, Collection<Integer> options) {
    }

    record FloorState(int floor, List<Collection<Integer>> state) {
    }
}