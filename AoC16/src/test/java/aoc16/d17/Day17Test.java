...
public class Day17Test {
    ...
    static boolean isOpen(char code) {
        return code >= 'b' && code <= 'f';
    }
    ...
    static String md5(String text) {
        return new Md5Util().md5(text).toLowerCase();
    }
    ...
    record PathPoint(String path, Point point) {
    }

    record DirPoint(Direction direction, Optional<Point> point) {
    }

    record PathLength(String path, int length) {
    }
}
