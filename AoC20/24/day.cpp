...
const vector<Direction> DirectionList{East, SouthEast, SouthWest,
...
TEST_CASE("Day24", "[24]") {
  ...
  for (int day = 1; day <= 100; day++) {
    const auto [minX, maxX] =
        minmax_element(counter.begin(), counter.end(),
                       [](const PosCount &a, const PosCount &b) {
